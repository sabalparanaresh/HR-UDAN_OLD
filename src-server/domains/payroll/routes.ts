...
payrollRouter.post('/calculate-payroll-draft', (req: any, _res) => {
  const res = _res;
  const ctx = {
...
payrollRouter.post('/get-paginated-salary-results', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/get-payroll-exceptions', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/calculate-kmodule-wages', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/calculate-pmodule-statutory', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
  ...
  const args = req.body;
  const { statutoryDb, primaryDb } = ctx;
...
payrollRouter.post('/consolidate-final-payroll', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/commit-payroll', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/update-payroll-status', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/get-processed-payroll', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/piece-rate-crud', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
  ...
  const { operation, data, id, page, limit, search } = args;
          const { PieceRateService } = require('../../domains/piece-rate/service.js');
...
payrollRouter.post('/process-payroll', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/get-final-payroll', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/process-waterfall-distribution', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/get-payroll-preview', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/toggle-salary-lock', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/bulk-salary-lock', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/export-final-payroll', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
payrollRouter.post('/lock-final-payroll', (req: any, _res) => {
  const res = _res;
  const ctx = {
     primaryDb: req.primaryDb,
     statutoryDb: req.statutoryDb,
...
import * as txn from './transactions.js';
payrollRouter.post('/transaction/crud', async (req: any, res) => { try { const r = await txn.handleTransactionCrud({primaryDb: req.primaryDb, statutoryDb: req.statutoryDb}, req.body); res.json(r); } catch(e:any) { res.status(500).json({error: e.message}); } });
payrollRouter.post('/transaction/bulk-insert', async (req: any, res) => { try { const r = await txn.handleBulkInsert({primaryDb: req.primaryDb, statutoryDb: req.statutoryDb}, req.body); res.json(r); } catch(e:any) { res.status(500).json({error: e.message}); } });
payrollRouter.post('/transaction/save', async (req: any, res) => { try { const r = await txn.handleSaveTransaction({primaryDb: req.primaryDb, statutoryDb: req.statutoryDb}, req.body); res.json(r); } catch(e:any) { res.status(500).json({error: e.message}); } });
payrollRouter.post('/transaction/history', async (req: any, res) => { try { const r = await txn.handleGetHistory({primaryDb: req.primaryDb, statutoryDb: req.statutoryDb}, req.body); res.json(r); } catch(e:any) { res.status(500).json({error: e.message}); } });
payrollRouter.post('/transaction/earning-history', async (req: any, res) => { try { const r = await txn.handleEarningHistory({primaryDb: req.primaryDb, statutoryDb: req.statutoryDb}, req.body); res.json(r); } catch(e:any) { res.status(500).json({error: e.message}); } });
payrollRouter.post('/transaction/update', async (req: any, res) => { try { const r = await txn.handleUpdateTransaction({primaryDb: req.primaryDb, statutoryDb: req.statutoryDb}, req.body); res.json(r); } catch(e:any) { res.status(500).json({error: e.message}); } });
payrollRouter.post('/transaction/bulk-delete', async (req: any, res) => { try { const r = await txn.handleBulkDelete({primaryDb: req.primaryDb, statutoryDb: req.statutoryDb}, req.body); res.json(r); } catch(e:any) { res.status(500).json({error: e.message}); } });
payrollRouter.post('/transaction/save-arrear', async (req: any, res) => { try { const r = await txn.handleSaveArrear({primaryDb: req.primaryDb, statutoryDb: req.statutoryDb}, req.body); res.json(r); } catch(e:any) { res.status(500).json({error: e.message}); } });
payrollRouter.post('/transaction/save-daily-mis-batch', async (req: any, res) => { try { const r = await txn.handleSaveDailyMisBatch({primaryDb: req.primaryDb, statutoryDb: req.statutoryDb}, req.body); res.json(r); } catch(e:any) { res.status(500).json({error: e.message}); } });
